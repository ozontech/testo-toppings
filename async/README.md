...
> [!WARNING]
> Calls to [`t.Parallel`], [`t.Setenv`] and [`t.Chdir`] in async tests or tests with async ancestors are forbidden.
...
[`t.Setenv`]: https://pkg.go.dev/github.com/ozontech/testo#T.Setenv
[`t.Chdir`]: https://pkg.go.dev/github.com/ozontech/testo#T.Chdir
